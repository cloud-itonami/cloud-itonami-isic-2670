# Operator Quickstart — Manufacture of Optical Instruments and Photographic Equipment

Shortest path from clone to a verified local dry-run for **ISIC 2670** (`cloud-itonami-isic-2670`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2670.git
cd cloud-itonami-isic-2670
```
...
- Blueprint governor key: `module-seating-governor`
- Likely source path: `opticsworks.governor.cljc`
