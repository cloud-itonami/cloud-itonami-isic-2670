(ns opticalmfg.phase
  "Phase 0->3 staged rollout for the optical-instrument-and-
  ...
  consequence (a lens-grinding/optics-assembly/testing-equipment
  ...
  `opticalmfg.governor`'s `actuate-equipment-blocked-violations` HARD-
...
(defn verdict->disposition
  "Map an Optical Instrument Plant Operations Governor verdict to a
